...
import { View, Text, StyleSheet, Image } from "react-native"; 8
  ...
  return (
    ...
    >
      ...
      <Collapsible title="COMO FUNCIONA ?">
        <ThemedText style={styles.contentText}>
          Aqui está uma nova seção colapsável, onde você pode adicionar mais informações ou funcionalidades ao seu app.
        </ThemedText>
        <ThemedText style={styles.contentText}>
          Sinta-se livre para modificar o conteúdo dessa aba conforme necessário.
        </ThemedText>
      </Collapsible>
